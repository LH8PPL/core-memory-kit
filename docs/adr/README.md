...
| [0017](0017-memory-learn-loop-cross-session-runtime-judge-as-adapter.md) | The kit as a cross-session learn-loop — session=bounded episode, kit=cross-session runtime, missing organ=learn-from-failure, judge-as-per-host-adapter, portfolio signal (prune>reinforce) | proposed | 2026-07-01 |
