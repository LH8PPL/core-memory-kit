...
- [x] **91 — MEMORY.md graduation (write-lock safety valve)** — _shipped 2026-06-04, PR #113 (D-54/D-57). The sole hard blocker; now cleared. Transactional cap-pressure valve, search-only, project MEMORY.md only; recall of graduated facts is v0.3 (Task 75)._
