...
> **This file is a pointer, not state.** Where we are + what's next lives in the **Spine** — read it there, not here. Per [`../DOCUMENTATION-MAP.md`](../DOCUMENTATION-MAP.md), current project state lives ONLY in requirements/design/tasks; a handoff file that carries its own state always drifts (this one did — 425 lines of stacked, superseded blocks, now folded into `tasks.md`).
