...
| **IDE hooks** | `.kiro/hooks/cmk.kiro.hook.json` (Kiro IDE 1.0+ v1 format) + legacy `cmk-{capture,inject}.kiro.hook` (older Kiro) | the **GUI** — recall + capture + a delete-guard (`PreToolUse`) + large-edit observation (`PostFileSave`) |
