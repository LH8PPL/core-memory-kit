...
> **v0.2.0 GATE (binding — D-24/the user 2026-06-01: *"dont cut to 0.2.0 until we fix the problems and then do live test again, on a new project"*; extended D-54 2026-06-04):** do NOT push the `v0.2.0` tag until ALL of — (1) Task 63 (F1) merged, (2) Task 64 (F2) merged, (3) **Task 91 (MEMORY.md graduation) merged** — the hot index write-locks after ~2 sessions without it (D-54), and (4) a **fresh live test on a NEW project** confirms MEMORY.md/fact-files are rich AND HABITS.md fills AND MEMORY.md stays under cap across multiple capture sessions. `main` is at 0.2.0, un-tagged. Task 65 is post-v0.2.
